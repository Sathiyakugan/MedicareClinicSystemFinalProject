...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" >
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Doctor DB</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right"  >
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a  data-a="../Admin/profile.php?type=Doctor&username=<?php echo $doctor->getUsername();?>" href='#editarUsuario' class='modalEditarUsuario'  data-toggle='modal' data-backdrop='static' data-keyboard='false' title='Editar usuario'    ><i class="fa fa-user fa-fw"></i> <?php echo $doctor->getFirstName();?> </a>
                </li>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="../Admin/update.php?type=Doctor&username=<?php echo $doctor->getUsername();?>">UpdateProfile</a>
                        </li>
                        <li>
