<?php
    ...
    $sql = "SELECT * FROM kugan WHERE username='$current_user'";
	      ...
	      <div class="fluid-container">
	        <div class="navbar-header">
	          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse1">
                ...
                <a class="navbar-brand" href="home.php"><b>MEDICARE</b></a>
            </div>
	        <div class="navbar-collapse collapse" id="navbar-collapse1">
	           <ul class="nav navbar-nav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $row['FirstName'];?> <?php echo $row['LastName'];?><strong class="caret"></strong></a>
