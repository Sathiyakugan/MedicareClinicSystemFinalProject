...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM prescription")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
?> 
			...
			$(document).ready(function()
	{
		...
		<?php
		$invNum= mysqli_query($GLOBALS["___mysqli_ston"], "SELECT 1+MAX(invoice_id) FROM invoice");
		...
		<form name="myform" onsubmit="return validateForm(this);" action="invoice.php" method="post" >
			<table width="200" height="106" border="0" >	
				...
				echo"<select  class=\"input-small\" name=\"drug_name\" style=\"width:170px\" id=\"drug_name\">";
						 $getpayType=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT drug_name FROM stock");
