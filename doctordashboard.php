            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <a href="../Doctor/profile.php?type=Doctor&username=<?php echo $admin->getUsername();?>"><i class="fa fa-dashboard fa-fw"></i> profile </a>

                        <a href="Pataint_db.php"><i class="fa fa-edit fa-fw"></i>Patients</a>

                        <a href="Appoinment_pat.php"><i class="fa fa-edit fa-fw"></i>Appoinment</a>

                        <a href="Pataint_pricription_db.php"><i class="fa fa-edit fa-fw"></i>Priscription</a>
                    </li>
                    <li>
