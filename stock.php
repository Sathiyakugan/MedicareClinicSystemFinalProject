...
$sql=mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO stock(drug_name,category,description,company,supplier,quantity,cost,status,date_supplied)
...
<hr/>	
    <div class="tabbed_area">  
		...
		*/
        ...
        $result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM stock") 
