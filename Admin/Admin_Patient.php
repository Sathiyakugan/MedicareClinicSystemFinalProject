                        ...
                        <div class="tab-content">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        */
                                        ...
                                        for($i=0;$i<$count;$i++) {
                                            ...
                                            <td><a href="../Admin/delete.php?type=Patient&username=<?php echo $details[$i]['username']?>"><button type="button" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">Delete</button></a></td>
                                            <?php
                                        }
                                        ?>
                                        </tbody>
                            ...
                            <div class="tab-pane fade" id="profile">
                                <div class="col-md-12">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <form role="form" name="form1" class="form-signin"  onsubmit="return add_Staff();" id="form1" data-toggle="validate"  method="post" action="Admin_Patient.php" enctype="multipart/form-data">
