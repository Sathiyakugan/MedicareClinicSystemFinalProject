...
class Admin_Receptionist
{
    ...
    public function getresults(){
        $this->db->connect();
        $this->db->select('receptionist','first_name,last_name,username,sex,DOB,address,email,phone,user_image,staff_id,receptionist_id',NULL,NULL,NULL); // Table name, Column Names, JOIN, WHERE conditions, ORDER BY conditions
    ...
    public function getresultsforaperson($username){
        ...
        $this->db->connect();
        $this->db->select('receptionist','first_name,last_name,username,sex,DOB,address,email,phone,user_image,staff_id,receptionist_id',NULL,$quer,NULL); // Table name, Column Names, JOIN, WHERE conditions, ORDER BY conditions
        $res =$this->db->getResult();
        return $res;
    }
    public function Update($username,$firstName,$lastName,$sex,$DOB,$address, $email,$user_image,$staff_id){
        ...
        $this->db->connect();
        $this->db->update('receptionist',array('first_name'=>'"'.$firstName.'"','last_name'=>'"'.$lastName.'"','sex'=>'"'.$sex.'"','DOB'=>'"'.$DOB.'"','address'=>'"'.$address.'"','email'=>'"'.$email.'"','user_image'=>'"'.$user_image.'"','staff_id'=>'"'.$staff_id.'"'),'username="'.$username.'"'); // Table name, column names and values, WHERE conditions
    }
    ...
    public function Insert($username,$password,$firstName,$lastName,$DOB,$address,$email,$phone,$sex,$user_image,$staff_id){
        ...
        if (sizeof($results)==0){
            ...
            $this->db->insert('receptionist',array('username'=>$username,'password'=>$password,'first_name'=>$firstName,'last_name'=>$lastName,'sex'=>$sex,'phone'=>$phone,'DOB'=>$DOB,'address'=>$address,'email'=>$email,'user_image'=>$user_image,'staff_id'=>$staff_id,'phone'=>$phone));  // Table name, column names and respective values
    ...
    public function Delete($username){
        ...
        $this->db->delete('receptionist',"'".$username."'");  // Table name, WHERE conditions
    }
}
?>
...
if(isset($_SESSION['current_user'])){
    ...
    $admin_receptionist= new Admin_Receptionist();
}else{
...
if(isset($_POST['submit'])){
    ...
    $admin_receptionist->Insert($username,$password,$firstName,$lastName,$DOB,$address,$email,$phone,$sex,$user_image,$staff_id);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Manage Receptionist</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="home">
                                ...
                                <div class="table-responsive">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        /*
                                        View
                                        Displays all data from 'receptionist' table
                                        */
                                        // get results from database
                                        $details=$admin_receptionist->getresults();
                                        ...
                                        for($i=0;$i<$count;$i++) {
                                            ...
                                            echo "<tr>";
                                            echo '<td>' . $details[$i]['receptionist_id'] . '</td>';
                                            echo '<td>' . $details[$i]['first_name'] . '</td>';
                                            echo '<td>' . $details[$i]['phone'] . '</td>';
                                            ?>
                                            <td><button type='button' data-a="../Admin/profile.php?type=Receptionist&username=<?php echo $details[$i]['username']?>" href='#editarUsuario' class='modalEditarUsuario btn btn-primary'  data-toggle='modal' data-backdrop='static' data-keyboard='false' title='Editar usuario'>ViewProfile</button></td>
                                            <td><a href="../Admin/update.php?type=Receptionist&username=<?php echo $details[$i]['username']?>"><button type="button" class="btn btn-primary">Update</button></a></td>
                                            <td><a href="../Admin/delete.php?type=Receptionist&username=<?php echo $details[$i]['username']?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
                                            <?php
                                        }
                                        ?>
                                        </tbody>
                            ...
                            <div class="tab-pane fade" id="profile">
                                <form name="form1" class="form-signin" onsubmit="return validateForm(this);" method="post" action="Admin_Receptionist.php" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        */
                                        ...
                                        for($i=0;$i<$count;$i++) {
                                            ...
                                            <td><button type='button' data-a="../Admin/profile.php?type=Receptionist&username=<?php echo $details[$i]['username']?>" href='#editarUsuario' class='modalEditarUsuario btn btn-primary'  data-toggle='modal' data-backdrop='static' data-keyboard='false' title='Editar usuario'>ViewProfile</button></td>
                                            <td><a href="../Admin/update.php?type=Receptionist&username=<?php echo $details[$i]['username']?>"><button type="button" class="btn btn-primary">Update</button></a></td>
                                            <td><a href="../Admin/delete.php?type=Receptionist&username=<?php echo $details[$i]['username']?>"><button type="button" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">Delete</button></a></td>
                                            <?php
                                        }
                                        ?>
                                        </tbody>
                            ...
                            <div class="tab-pane fade" id="profile">
                                <div class="col-md-12">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <form role="form" name="form1" class="form-signin"  onsubmit="return add_Staff();" id="form1" data-toggle="validate"  method="post" action="Admin_Receptionist.php" enctype="multipart/form-data">
