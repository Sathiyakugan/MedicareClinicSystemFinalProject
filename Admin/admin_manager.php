...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM manager WHERE username='$user'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
 $result=mysqli_fetch_array($sql1);
 if($result>0){
$message="<font color=blue>sorry the username entered already exists</font>";
 }else{
$sql=mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO manager(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)
...
<hr/>	
    <div class="tabbed_area">  
		...
		*/
        ...
        $result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM manager") 
