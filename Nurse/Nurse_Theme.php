...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" >
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Nurse DB</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right"  >
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a  data-a="../Admin/profile.php?type=Nurse&username=<?php echo $nurse->getUsername();?>" href='#editarUsuario' class='modalEditarUsuario'  data-toggle='modal' data-backdrop='static' data-keyboard='false' title='Editar usuario'    ><i class="fa fa-user fa-fw"></i> <?php echo $nurse->getFirstName();?> </a>
                </li>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="nursedashboard.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                </li>
                <li>
